...
// GET - List all testimonials with pagination and sorting
export async function GET(request) {
  try {
    ...
    let sort_by = searchParams.get('sort_by') || 'testimonial_id';
    ...
    const sortField = sortMap[sort_by] || 't.testimonial_id';
    ...
    if (active !== 'false' && active !== '0' && active !== 'all') {
