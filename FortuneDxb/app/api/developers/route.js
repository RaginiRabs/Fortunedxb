...
export async function GET(request) {
  try {
    ...
    let sort_by = searchParams.get('sort_by') || 'developer_id';
    ...
    const sortField = sortMap[sort_by] || 'd.developer_id';

    // Get total count
    const countRows = await query('SELECT COUNT(*) as total FROM developers');
