...
const initialFormData = {
  ...
  // Step 2: Project Information + Contact
  total_towers: '',
  total_units: '',
  units_sold: '',
  furnishing_status: '',
  ...
  // Step 5: Location - UPDATED with separate iframe and link
  location_iframe: '',    // Full iframe embed code
  location_link: '',      // Direct Google Maps URL
  nearby_locations: [],
...
export function ProjectFormProvider({ children, editMode = false, projectId = null, initialData = null }) {
  ...
  const getSubmitData = useCallback(() => {
    ...
    return {
      manual_project_id: formData.manual_project_id || null,
      ...
      location_iframe: formData.location_iframe || null,
