...
export function getUploadPath(type, entityId = null) {
  switch (type) {
    ...
    case 'testimonial':
      return path.join(UPLOAD_BASE_DIR, 'Testimonial');
    case 'oqood':
      return path.join(UPLOAD_BASE_DIR, 'Oqood');
    default:
...
/**
 * Save single file (for logo, cover, award, projectlogo, brochure, gallery, floorplan, testimonial, etc.)
