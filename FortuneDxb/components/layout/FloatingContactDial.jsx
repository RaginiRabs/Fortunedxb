...
const FloatingContactDial = () => {
  ...
  const actions = [
    ...
    },
    {
      ...
      hoverColor: theme.palette.navy.light,
    },
    {
      icon: <Mail size={20} />,
      name: 'Email',
      ...
      hoverColor: theme.palette.gold.dark,
    },
    {
      icon: <Video size={20} />,
      name: 'Video Call',
      ...
      >
        ...
        <Fab
          ...
          sx={{
            ...
            borderRadius: 1,
            boxShadow: `0 8px 25px ${alpha(theme.palette.gold.main, 0.4)}`,
            transition: 'all 0.3s ease',
            '&:hover': {
              background: `linear-gradient(135deg, ${theme.palette.gold.dark} 0%, ${theme.palette.gold.dark} 100%)`,
              transform: 'scale(1.05)',
            },
          }}
        >
          {open ? (
            <X size={24} color={theme.palette.common.white} />
          ) : (
            <MessageCircle size={24} color={theme.palette.common.white} />
          )}
        </Fab>
      </Box>
    </ClickAwayListener>
