...
// prototype5 projects browser — functional filters, sort, load-more, grid/list. Mock only.
              ...
              {shown.map((p) => (
                <article key={p.name} className={`group overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-[0_12px_34px_-16px_rgba(20,18,15,0.2)] transition-all duration-300 hover:-translate-y-1 hover:border-[#80603f]/30 hover:shadow-[0_24px_50px_-18px_rgba(128,96,63,0.3)] ${view === 'list' ? 'flex' : ''}`}>
                  ...
                  <div className="flex-1 p-5">
                    ...
                    <a href="/prototype5/project/one-by-nine" className={`mt-4 flex items-center justify-center gap-1.5 rounded-lg border border-[#80603f]/40 px-5 py-2.5 text-[13px] font-medium text-[#80603f] transition-colors hover:bg-[#80603f] hover:text-white ${view === 'list' ? 'w-fit' : 'w-full'}`}>
