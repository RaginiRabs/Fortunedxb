// prototype1 top-communities — photo cards with price & ROI. Mock only.
  ...
  return (
    <div>
      <div className="flex items-end justify-between">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#B89149]">Explore</p>
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
        {topCommunities.map((c) => (
          <article
            key={c.id}
            className="group overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-[0_12px_36px_-14px_rgba(20,18,15,0.22)] transition-all duration-300 hover:-translate-y-1.5 hover:border-[#B89149]/30 hover:shadow-[0_26px_55px_-15px_rgba(184,145,73,0.35)]"
          >
            ...
            <div className="p-4">
              ...
              <p className="text-[15px] font-semibold text-[#B89149]">
              ...
              <div className="mt-3 flex items-center justify-between border-t border-gray-100 pt-3">
                ...
                <span className="inline-flex items-center gap-1 text-[11px] font-medium text-[#B89149]">
