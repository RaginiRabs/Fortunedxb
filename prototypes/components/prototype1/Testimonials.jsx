// prototype1 testimonials — client reviews. Mock only.
import { Star, Quote } from 'lucide-react';
import { testimonials } from '@/mock/prototype1/home';
...
export default function Testimonials() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-[#faf6ef]">
      <div className="pointer-events-none absolute -left-32 bottom-0 h-72 w-72 rounded-full bg-[#B89149]/10 blur-3xl" />
      <div className="relative mx-auto max-w-[1400px] px-4 py-16 md:px-8">
        <div className="text-center">
          <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-[#B89149]">Testimonials</p>
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
          {testimonials.map((t) => (
            ...
            >
              <Quote className="absolute right-6 top-6 h-8 w-8 text-[#B89149]/15" />
              <div className="flex gap-1 text-[#B89149]">
              ...
              <figcaption className="mt-6 flex items-center gap-3 border-t border-gray-100 pt-5">
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-gradient-to-br from-[#C8A24E] to-[#A37F3C] text-sm font-semibold text-white">
                  {initials(t.name)}
                </span>
                <span>
