// prototype1 Projects page — content only; shared layout adds navbar + footer. Mock only.
import {
...
import PageHero from '@/components/prototype1/PageHero';
import ProjectsBrowser from '@/components/prototype1/ProjectsBrowser';
          ...
          {FEATURED.map((p, i) => (
            <Reveal key={p.name} delay={i * 0.08} className="group relative h-64 overflow-hidden rounded-2xl shadow-[0_14px_40px_-16px_rgba(20,18,15,0.3)]">
              ...
              <div className="absolute inset-x-4 bottom-4 text-white">
                ...
                <a href="/prototype1/project/one-by-nine" className="mt-3 inline-flex rounded-md bg-gradient-to-r from-[#96714a] to-[#6b4f33] px-4 py-1.5 text-[12px] font-medium">View Details</a>
              </div>
            </Reveal>
          ))}
        </div>
      ...
      <section className="mx-auto max-w-[1400px] px-4 py-14 md:px-8">
        ...
        <div className="mt-5 grid grid-cols-1 gap-6 lg:grid-cols-[1fr_300px]">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-[#0a1320] p-6 text-white">
            ...
            <a href="/prototype1/contact" className="mt-5 inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-[#96714a] to-[#6b4f33] px-5 py-2.5 text-sm font-medium text-white">
