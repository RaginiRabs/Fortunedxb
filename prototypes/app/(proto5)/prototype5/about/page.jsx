// prototype5 About Us page — content only; shared layout adds the navbar + footer. Mock only.
import {
  Building2, Users, Handshake, MapPin, Award, ShieldCheck, BarChart3,
  CheckCircle2, ArrowRight,
} from 'lucide-react';
import Reveal from '@/components/prototype5/Reveal';
import CountUp from '@/components/prototype5/CountUp';
      ...
      <section className="relative -mt-[88px] overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1400px] px-4 pb-20 pt-[150px] md:px-8 md:pb-28">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <a href="/prototype5" className={GOLD_BTN}>Our Projects <ArrowRight className="h-4 w-4" /></a>
        ...
        <div className="relative overflow-hidden rounded-2xl">
          ...
          <div className="relative flex flex-col items-center justify-between gap-6 px-8 py-12 text-center lg:flex-row lg:text-left">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a href="/prototype5" className={GHOST_BTN}>Browse Properties <ArrowRight className="h-4 w-4" /></a>
            </div>
          </div>
        </div>
      </section>
