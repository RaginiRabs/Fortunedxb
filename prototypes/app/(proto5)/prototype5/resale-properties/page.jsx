// prototype5 Resale Properties page — content only; shared layout adds navbar + footer. Mock only.
import {
...
import ResaleBrowser from '@/components/prototype5/ResaleBrowser';
            ...
            <Reveal key={p.name + i} delay={i * 0.08} className="group overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-[0_12px_34px_-16px_rgba(20,18,15,0.2)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_50px_-18px_rgba(128,96,63,0.3)]">
              ...
              <div className="p-4">
                ...
                <div className="mt-3 flex items-center justify-between border-t border-gray-100 pt-3">
                  ...
                  <a href="/prototype5/project/one-by-nine" className="inline-flex items-center gap-1 text-[12px] font-medium text-[#80603f] hover:underline">View Property <ArrowRight className="h-3.5 w-3.5" /></a>
                </div>
              </div>
            </Reveal>
          ))}
          ...
          <div className="relative overflow-hidden rounded-2xl bg-[#0a1320] p-8 text-white">
            ...
            <div className="relative">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a href="/prototype5/contact" className={GOLD_BTN}>Schedule a Consultation <ArrowRight className="h-4 w-4" /></a>
