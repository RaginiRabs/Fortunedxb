// prototype5 Distress Deals page — content only; shared layout adds navbar + footer. Mock only.
import {
...
import SavingsCalculator from '@/components/prototype5/SavingsCalculator';
import FaqAccordion from '@/components/prototype5/FaqAccordion';
import DistressBrowser from '@/components/prototype5/DistressBrowser';
            ...
            <Reveal key={d.name} delay={i * 0.08} className="group overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-[0_12px_34px_-16px_rgba(20,18,15,0.2)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_50px_-18px_rgba(128,96,63,0.25)]">
              ...
              <div className="p-4">
                ...
                <div className="mt-3 flex items-center gap-2">
                  <a href="/prototype5/project/one-by-nine" className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-gray-200 py-2 text-[12px] font-medium text-[#1a1a1a] transition-colors hover:border-[#80603f] hover:text-[#80603f]">View Details <ArrowRight className="h-3.5 w-3.5" /></a>
                  <a href="/prototype5/project/one-by-nine" aria-label="Open" className="grid h-9 w-9 place-items-center rounded-lg bg-[#80603f] text-white"><ArrowUpRight className="h-4 w-4" /></a>
                </div>
              </div>
            </Reveal>
          ))}
      ...
      <section className="mx-auto max-w-[1400px] px-4 pb-14 md:px-8">
        ...
        <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-[1fr_300px] lg:items-stretch">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-[#0a1320] p-6 text-white">
            ...
            <a href="/prototype5/contact" className="mt-5 inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-[#96714a] to-[#6b4f33] px-5 py-2.5 text-sm font-medium text-white"><MessageCircle className="h-4 w-4" /> Talk to an Expert</a>
          </div>
        </div>
      </section>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-[#0a1320]">
          ...
          <div className="relative flex flex-col items-center justify-between gap-6 px-8 py-12 text-center lg:flex-row lg:text-left">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a href="/prototype5/contact" className="inline-flex items-center gap-2 rounded-md border border-white/30 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-white/10">Schedule a Consultation</a>
            </div>
          </div>
        </div>
      </section>
